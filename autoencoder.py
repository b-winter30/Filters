...
train_dataset = torchvision.datasets.MNIST(root=data_dir, train=True, download=True, transform=None)
test_dataset  = torchvision.datasets.MNIST(root=data_dir, train=False, download=True, transform=None)
...
def train_epoch(encoder, decoder, device, dataloader, loss_fn, optimizer):
    ...
    print('\t Loss : %f' % np.mean(train_loss))
